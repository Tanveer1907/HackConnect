                        ...
                        <form onSubmit={handleAdminSendOtp} className="space-y-4">
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <button type="button" className="absolute right-3 top-3 text-slate-500 hover:text-white disabled:opacity-50" onClick={() => setShowPassword(!showPassword)} disabled={otpSent}>
                                        {showPassword ? <FaEyeSlash className="w-4 h-4" /> : <FaEye className="w-4 h-4" />}
                                    </button>
                                </div>
                            </div>
